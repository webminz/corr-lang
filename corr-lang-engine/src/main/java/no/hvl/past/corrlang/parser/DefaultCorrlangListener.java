...
public class DefaultCorrlangListener extends CorrlangBaseListener {
    ...
    @Override
    public void enterGoal(no.hvl.past.corrlang.parser.CorrlangParser.GoalContext ctx) {
        this.currentStartLine = ctx.getStart().getLine();
        this.currentStartColumn = ctx.getStart().getCharPositionInLine();
    }

    @Override
    public void enterGoalName(no.hvl.past.corrlang.parser.CorrlangParser.GoalNameContext ctx) {
        this.currenGoal = new Goal(ctx.getText());
    }


    @Override
    public void exitGoal(no.hvl.past.corrlang.parser.CorrlangParser.GoalContext ctx) {
    ...
    @Override
    public void enterGoalTechSpace(no.hvl.past.corrlang.parser.CorrlangParser.GoalTechSpaceContext ctx) {
        this.currenGoal.setTechnology(ctx.getText());
    }

    @Override
    public void enterGoalActionType(no.hvl.past.corrlang.parser.CorrlangParser.GoalActionTypeContext ctx) {
        switch (ctx.getText()) {
            case "SCHEMA":
    ...
    @Override
    public void enterServerTarget(no.hvl.past.corrlang.parser.CorrlangParser.ServerTargetContext ctx) {
        this.currenGoal.setTarget(GoalTarget.server());
    }

    @Override
    public void enterServerTargetContextPath(no.hvl.past.corrlang.parser.CorrlangParser.ServerTargetContextPathContext ctx) {
        try {
    ...
    @Override
    public void enterServerTargetPort(no.hvl.past.corrlang.parser.CorrlangParser.ServerTargetPortContext ctx) {
        try {
            this.currenGoal.forTarget(new GoalTarget.Visitor() {
                @Override
                public void handle(GoalTarget.ServerRuntime serverRuntime) throws Exception {
    ...
    @Override
    public void enterCodegenTarget(no.hvl.past.corrlang.parser.CorrlangParser.CodegenTargetContext ctx) {
        this.currenGoal.setTarget(GoalTarget.codegen());
    }

    @Override
    public void enterFileTarget(no.hvl.past.corrlang.parser.CorrlangParser.FileTargetContext ctx) {
        this.currenGoal.setTarget(GoalTarget.file());
    }

    @Override
    public void enterBatchTarget(no.hvl.past.corrlang.parser.CorrlangParser.BatchTargetContext ctx) {
