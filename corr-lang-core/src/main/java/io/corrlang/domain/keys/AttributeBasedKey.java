...
public class AttributeBasedKey implements Key {
    ...
    public AttributeBasedKey(Endpoint originalSystem, Triple attributeEdge, Name targetType) {
        this.attributeEdges = Collections.singletonList(attributeEdge);
        this.targetType = targetType;
        this.originalSystem = originalSystem;
    }

    public AttributeBasedKey(Endpoint originalSystem, Name targetType, List<Triple> propertyPath) {
        this.attributeEdges = propertyPath;
        this.targetType = targetType;
        this.originalSystem = originalSystem;
    }

    public AttributeBasedKey(Endpoint originalSystem, Name targetType, Triple... propertyPath) {
